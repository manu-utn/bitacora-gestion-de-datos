...
** Ejemplo
   #+BEGIN_SRC plantuml :file img/btree-1.png :exports result
     @startuml
     note as nodoRaiz
     |= Clave |= Link |
     | 5  |  * |
...
*** Ejemplo 1 - Antes de eliminar nodo
    ...
    #+BEGIN_SRC plantuml :file img/btree-fusion.png :exports result
      @startuml
...
*** Ejemplo 1 - Despues de eliminar el nodo
    ...
    #+BEGIN_SRC plantuml :file img/btree-fusion2.png :exports result
      @startuml
      left to right direction
